//
//  WoundTypesTableViewController.m
//  WoundCare
//
//  Created by nathan bardgett on 10/18/10.
...
@implementation WoundTypesTableViewController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [app.woundTypeDataObjectModel.dataSource count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    WoundCareAppDelegate *app = (WoundCareAppDelegate*)[[UIApplication sharedApplication] delegate];
    CellDataObject *cdo = (CellDataObject*)[app.woundTypeDataObjectModel.dataSource objectAtIndex:indexPath.row];
...
-(NSString*)tableView:(UITableView*)tableView titleForHeaderInSection:(NSInteger)section{
    return @"Please pick a wound type";
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	 ...
	 */
    PressureUlcerAssessmentTableViewController *view = [[PressureUlcerAssessmentTableViewController alloc] init];
